          ...
          {!load && children ? (
            <div>
              ...
              {getLoginContexts.loginPopup && (
                <div
                  className={
                    " rounded-lg w-full h-screen fixed left-0 top-0 flex justify-center items-center z-40"
                  }
                >
                  ...
                  <div className="flex flex-row items-stretch rounded-lg">
                    <div className="absolute  left-[75px] w-[380px] h-[670px] text-qblue-white bg-custom-blue">
                      <div className="absolute top-[275px] left-[103px] w-[171px] h-[600px]">
                        <div className="text-sm absolute top-[176px] left-[12px] text-base leading-[27px] text-qblue-white">
                          Customer Success
                        </div>
                        <b className="absolute top-[150px] left-[5px] text-lg ">
                          Company Name
                        </b>
                        <div className="absolute top-[0px] left-[60px] rounded-[50%] w-[60px] h-[60px]" />
                      </div>
                      <div className="absolute top-[180px] left-[0px] text-[26px] leading-[44.2px] font-medium text-center inline-block w-[376px]">
                        <img
                          className="absolute top-[-60px] left-[160px] rounded-[50%] w-[60px] h-[60px]"
                          alt=""
                          src="/public/assets/images/comma.png"
                        />
                        <p className="m-0">
                          “The product given even exceeds my expectations,
                        </p>
                        <p className="m-0">I am very satisfied.”</p>
                      </div>
                    </div>
                    <div className="flex-grow-0 lg:w-[572px] w-full lg:h-[670px] h-full bg-white flex flex-col justify-center sm:p-10 p-5 border border-[#E0E0E0] relative z-40">
                      <div
